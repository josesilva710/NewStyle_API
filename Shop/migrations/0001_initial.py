    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_address', models.CharField(blank=True, max_length=255, null=True)),
                ('payment_method', models.CharField(choices=[('PIX', 'Pix'), ('CREDIT_CARD', 'Credit Card'), ('DEBIT_CARD', 'Debit Card'), ('BOLETO', 'Boleto')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('PANTS', 'Calças'), ('SHIRTS', 'Camisas'), ('BERMUDAS', 'Bermudas'), ('DRESSES', 'Vestidos'), ('SKIRTS', 'Saias'), ('SHORTS', 'Shorts'), ('BLOUSES', 'Blusas')], max_length=50)),
            ],
            options={
